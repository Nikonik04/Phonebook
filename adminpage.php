...
<?php
    ...
    echo "Ваш статус -> администратор</div>";
?>
<form action="" method="POST">
    ...
    ?>
    <a href="profile1.php" class="link">Профиль</a>
</form>
<form method="POST">
        <?php
            ...
            if (isset($_POST["butt5"])){
                ...
                $x = $_POST["del_row"];
                // выборка данных из таблицы
                $sql = "DELETE FROM telefon WHERE fio = '$x'";
                $result = mysqli_query($conn, $sql);
            }
        ?>
        <br>
        <a href="send.php">На страницу отправки</a>
        ...
        <label for="del_row">Фамилия для удаления: </label>
        <input type="text" name="del_row" id="del_row">
        <button name="butt5">Удалить</button>
    </form>
</body>
